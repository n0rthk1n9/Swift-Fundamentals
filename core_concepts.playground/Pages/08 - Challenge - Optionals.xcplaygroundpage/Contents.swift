...
// parsedInt is an optional because the String to parse could contain anything and if it for example would contain Banana, it won't be parsable to Int
/*:
 ## Challenge 3
...
// newParsedInt is nil because cat can't be parsed to an Int
